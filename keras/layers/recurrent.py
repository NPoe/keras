...
class Recurrent(Layer):
    ...
    def compute_output_shape(self, input_shape):
        ...
        if self.return_sequences:
            shape = (input_shape[0], input_shape[1], self.units)
        else:
    ...
    def _call(self, inputs, mask=None, training = None, initial_state = None):
        ...
        last_output, outputs, last_states, states = K.rnn(self.step,
                                             preprocessed_input,
                                             initial_state,
    ...
    def call(self, inputs, mask = None, training = None, initial_state = None):
        last_output, outputs, last_states, states = self._call(inputs, mask = mask, training = training, initial_state = initial_state)
...
class LSTM(Recurrent):
    ...
    def step(self, inputs, states):
        ...
        if self.implementation == 2:
            ...
            hh = self.activation(x_c + K.dot(h_tm1 * rec_dp_mask[2], self.recurrent_kernel_c))
